...
import com.beans.GestionReclamos;
...
@ManagedBean
@SessionScoped // JEE
@FacesValidator(value ="validatorModificarEstadoReclamo", managed = true) // JEE8
//@ConversationScoped
public class ValidatorModificarEstadoReclamo implements Validator<String>, Serializable {
	...
	@Inject
	GestionReclamos gestionReclamos;
	...
	public void validate(FacesContext arg0, UIComponent arg1, String arg2) throws ValidatorException {
		...
		Estado estadoAModificar = new Estado();
		try {
			estadoAModificar = gestionReclamos.getEstadoAEditar();
			estados = persistenciaBean.listarEstados();
		} catch (Exception e) {
			e.printStackTrace();
		}
